...
def inject_premium_css():
    # 🔥 Creative, premium medical/tech dark background from Unsplash
    bg_url = "https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?q=80&w=2000&auto=format&fit=crop"
    ...
    .stApp {{
        background: linear-gradient(rgba(10, 15, 30, 0.85), rgba(10, 20, 40, 0.85)), url("{bg_url}");
...
def registration_page():
    ...
    # EXACT Text from your original code
    st.markdown("<h1 style='text-align: center; font-size: 40px;'>📝 Patient Registration</h1>", unsafe_allow_html=True)
...
def prediction_page():
    ...
    # -----------------------------
       st.markdown("<h1 style='font-size: 40px;'>🩺 Diabetes Prediction System</h1>", unsafe_allow_html=True)
       st.markdown("<p style='font-size: 18px; color:#cbd5e1;'>AI-Powered Diabetes Risk Assessment Tool</p>", unsafe_allow_html=True)
       ...
       if predict_btn:
         ...
         with col2:
             ...
             fig = go.Figure(go.Indicator(
                ...
                gauge={"axis": {"range": [0, 100], "tickcolor":"white"}, "bar": {"color": "rgba(255,255,255,0.4)"}, "steps": [{"range": [0, 30], "color": "#10b981"}, {"range": [30, 70], "color": "#f59e0b"}, {"range": [70, 100], "color": "#ef4444"}]}
             ))
         ...
         with rf_c1:
             ...
             if risk_factors:
                 ...
                 st.markdown("<p style='color: white;'>No major risk factors identified.</p>", unsafe_allow_html=True)
             st.markdown('</div>', unsafe_allow_html=True)
         ...
         with rf_c2:
             ...
             if positive_factors:
                 ...
                 st.markdown("<p style='color: white;'>No positive indicators highlighted.</p>", unsafe_allow_html=True)
             st.markdown('</div>', unsafe_allow_html=True)
         ...
         bar_fig.update_xaxes(tickfont=dict(color="white", size=14), title_font=dict(color="white", size=16), showline=True, linecolor="rgba(255,255,255,0.2)")
         bar_fig.update_yaxes(tickfont=dict(color="white", size=14), title_font=dict(color="white", size=16), showgrid=True, gridcolor="rgba(255,255,255,0.1)", zerolinecolor="rgba(255,255,255,0.2)")
