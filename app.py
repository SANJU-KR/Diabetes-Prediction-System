...
import streamlit as st
try:
    uri = st.secrets["MONGO_URI"]   # Works on Streamlit Cloud
except:
    uri = "mongodb+srv://project00067:Project123@cluster0.vzzvdti.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # Works locally
...
# ✅ PDF Download Session Variables
...
""")
        ...
        # Generate recommendations based on risk
         ...
         # -----------------------------
    # SHOW DOWNLOAD BUTTON AFTER PREDICTION
    # -----------------------------
    
        if st.session_state.get("prediction_done") and st.session_state.get("pdf_data"):
...
This AI-generated report is for informational purposes only and does not replace professional medical consultation.
""")
